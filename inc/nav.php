			...
			<div class="menu-wrap">
				...
				<div class="header-xtra">
					<div class="s-cart">
						...
						<div class="cart-info">
							<small>You have <em class="highlight">#</em> in your shopping bag</small>
							<br>
							<br>
							<div class="ci-item">
								<img src="images/shop/2.jpg" width="70" alt=""/>
								<div class="ci-item-info">
									<h5><a href="#">Demo 1</a></h5>
									<p>demo price</p>
									<div class="ci-edit">
							...
							<div class="ci-item">
								...
								<div class="ci-item-info">
									<h5><a href="./single-product.html">item 1</a></h5>
									<p>price 1</p>
									<div class="ci-edit">
										<a href="#" class="edit fa fa-edit"></a>
										<a href="#" class="edit fa fa-trash"></a>
							...
							<div class="ci-total">total price</div>
							<div class="cart-btn">
								<a href="#">View Bag</a>
								<a href="#">Checkout</a>
							</div>
